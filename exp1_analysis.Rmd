...
```{r}
#combine plots
#pdf("charts/exp1_ext_int_chunks_plot.pdf", width = 14, height = 14)
#ext_chunks_plot + 
#  int_chunks_plot + 
#  plot_layout(ncol = 1,
#              guides = "collect",
...
```{r}
#dataviz for condition - logged for better viz.
#pdf("charts/exp1_vp_plot.pdf", height = 14, width = 14)
vp_viz <- exp1_tidied %>%
  ggplot(aes(x = RestrictorType, #group by condition on x axis
...
```{r}
#dataviz for condition - logged for better viz.
#pdf("charts/exp1_spill_plot.pdf", height = 14, width = 14)
...
```{r}
#combine plots
#pdf("charts/exp1_ext_int_chunks_adj_plot.pdf", width = 14, height = 14)
ext_chunks_plot_adj + 
  int_chunks_plot_adj + 
  plot_layout(ncol = 1,
              guides = "collect",
